...
- `chartCaption` 必须写成 JSX，不是普通字符串，使用 `<><p>...</p></>` 这种结构输出。
- 必须写成 3 到 5 个 `p` 段，每段约 120 个字，可以上下浮动，但不要只写一两句短评。
- 语言偏口语化，面向刚入门的小白，不要写成交易员黑话或新闻摘要。
- 第 1 段说清楚最近是涨、跌还是震荡，量能是放大还是缩小，整体看起来偏强还是偏弱。
- 第 2 段说清楚蜡烛图形态、价格行为和趋势线，解释市场是在接受新区间、拒绝突破，还是仍在箱体里拉扯。
- 第 3 段说清楚支撑位、压力位、MA5/MA10 或形态变化，并解释这些位置对后面的走势意味着什么。
- 如果写第 4 段或第 5 段，就补充量价关系、关键折线、节奏切换或短线博弈细节，不能重复前文。
- 最后一段必须说清楚接下来 1 到 3 个交易日更像是先震荡、先回踩，还是放量后继续走强。
- 预测要保留不确定性，不能写“必涨、必跌、确定突破”。
- 如果 `kLineData` 不足以支持趋势判断，就明确写“趋势证据不足”，但仍要给出支撑压力和短线倾向。
- 每一段都要结合上面已经完成的技术分析内容来总结，不能脱离蜡烛图、价格行为、支撑压力、趋势线、MA5/MA10 和量价关系另起炉灶。
...
chartCaption: (
  <>
    <p>
      最近这波走势更像沿着上升趋势线震荡上移，盘中虽然有过冲高回落，但收盘重心没有明显下沉，说明主线情绪还在，只是高位分歧开始增加。量能如果同步放大，通常代表资金愿意继续追价；如果只是价格上去、成交跟不上，就更像强势里的犹豫，而不是彻底转弱。
    </p>
    <p>
      长上影、探底回升、突破失败、回踩收复这些信号要连在一起看，核心不是某一根 K 线长得像什么，而是市场到底有没有接受新的价格区间。要是前面刚突破、后面又很快跌回原结构，往往说明追价资金不够坚决；反过来，如果回踩以后还能重新站回趋势线或箱体上沿，盘面就更偏向强势整理。
    </p>
    <p>
      支撑位、压力位和 MA5、MA10 最好放在同一个逻辑里理解，因为真正有意义的位置，往往不是单独一条线，而是均线、前低前高、趋势线或平台边界刚好叠在一起。这样的共振位更容易出现承接或受阻，所以不要只罗列数字，而要说明站稳以后节奏会不会继续抬高，跌破以后又会不会转成回踩确认。
    </p>
    <p>
      接下来 1 到 3 个交易日的节奏，通常更像先震荡换手、先回踩确认，还是补量后继续上探，要看关键位附近的承接是否真实存在。放量站回压力位上方，短线会偏强一些；回踩支撑不破，结构也还算健康；但要是量能始终跟不上，或者反弹总在压力位前后被压回来，那大概率还是反复拉扯为主。
    </p>
  </>
 )
```
