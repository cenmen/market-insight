  ...
  return (
    <div className='mt-[10pt] border-l-0 pl-0'>
      {items.map(function mapEvent(item) {
        return (
          <article
            className='relative mb-[8pt] break-inside-avoid pl-[18pt] before:absolute before:left-[5pt] before:top-[15pt] before:h-[calc(100%+8pt)] before:w-[1pt] before:bg-[#e8e6dc] last:before:hidden'
