  ...
  businessRatio: [
    {
      type: 'AI算力芯片与IP',
      rate: 23.27,
      desc: '海光信息、寒武纪、芯原股份构成国产AI算力芯片、处理器和芯片设计服务暴露。',
      subItems: [
        {
          type: '海光信息',
          rate: 9.66
    ...
    },
    {
      type: '晶圆制造与特色工艺',
      rate: 12.15,
      desc: '中芯国际、华虹公司代表先进制程、成熟制程和特色工艺晶圆代工能力。',
      subItems: [
        {
          type: '中芯国际',
          rate: 9.8
    ...
    },
    {
      type: '存储与接口芯片',
      rate: 11.57,
      desc: '澜起科技、佰维存储分别对应服务器内存接口芯片和存储模组周期修复。',
      subItems: [
        {
          type: '澜起科技',
          rate: 7.8
    ...
    },
    {
      type: '半导体设备',
      rate: 10.69,
      desc: '中微公司、拓荆科技覆盖刻蚀、薄膜沉积等国产半导体设备关键环节。',
      subItems: [
        {
          type: '中微公司',
          rate: 7.3
    ...
    },
    {
      type: '光芯片与高速互联',
      rate: 3.29,
      desc: '源杰科技提供高速光芯片和激光器芯片暴露，受益AI数据中心互联升级。',
      subItems: [
        {
          type: '源杰科技',
          rate: 3.29
