...
export default function HomePage() {
  return (
    <main className='grid min-h-screen place-items-center bg-[linear-gradient(135deg,#f5f3e8,#ece8d9)] px-6 py-8 font-["TsangerJinKai02","Source_Han_Serif_SC","Noto_Serif_CJK_SC",serif] text-[#29261f]'>
      <section className='w-full max-w-[768px] border border-[#ded9cc] bg-[#fbfaf3] p-5 shadow-[0_12px_30px_rgba(49,44,35,0.08)] md:p-8'>
        ...
        <ul className='m-0 grid list-none gap-3 p-0' aria-label="页面列表">
          {pageLinks.map((page) => (
            <li key={page.path}>
